...
public abstract class Entity {
	...
	void setVelocity(Vector2 velocity) {
		...
		if (speed > this.maxSpeed) {
			...
			// System.out.println("[WARN] speed exceeded this.maxSpeed while
			// creating entity."); //for debugging possible problems in future
			// code
		} else
	 ...
	 * 
	 * @return MIN_RADIUS Returns the minimum radius of the entity
	 */
	@Basic
	@Raw
	 ...
	 * 
	 * @param radius
	 * @return True if and only if the radius is greater than 0. | radius >= 0
	 */
	...
	public Entity(double x, double y, double xVelocity, double yVelocity, double radius, double orientation)
		...
		// DEFENSIVE
		// Variables of type double can never be null, so we do not have to
	...
	public void move(double dt) throws IllegalArgumentException, NegativeTimeException {
		...
		// this.setVelocity(Vector2.add(this.getVelocity(),
		// Vector2.multiply(this.getAccelerationVector(), dt)));
	...
	public void turn(double angle) {
		...
		if (this.orientation < 0) // due to the way java calculates %, we need
									// to add 2*PI to keep this number positive.
	...
	public static boolean overlap(Entity entity1, Entity entity2) throws NullPointerException {
		if (entity1 == null || entity2 == null)
			throw new NullPointerException("entities cannot be null.");
		if (entity1 == entity2) { // optimisation
			// System.out.println("De entities in functie overlap zijn hetzelfde
			// => geeft true"); //TODO: weg
			return true;
		}
